...
1. **Estructuración JSON (output.json)**: Mapear elementos extraídos a la estructura definida en spec.md para validación automática.
2. **Generación Markdown (resumen.md)**: Usar LLM para crear descripciones naturales y tablas de componentes, actores, entidades y flujos para validación humana.
3. **Generación de Diagrama (diagrama.mermaid)**: Crear diagrama Mermaid basado en los elementos extraídos para visualización.
4. **Lista de Faltantes (faltantes.md)**: Compilar hallazgos de validación en formato Markdown.
